#!/bin/bash
#SBATCH --job-name=v1v2_classifier_train_silva_138_2
...
SEQS_IN="/rds/projects/e/elhamsak-ad-thesis/reference_genomes/silva138_2/silva-138-2-ssu-nr99-seqs-dna.qza"
TAX_IN="/rds/projects/e/elhamsak-ad-thesis/reference_genomes/silva138_2/silva-138-2-ssu-nr99-tax.qza"
SEQS_V1V2="${OUT_DIR}/silva-138-2-v1v2-seqs.qza"
CLASSIFIER_OUT="${OUT_DIR}/silva-138-2-v1v2-classifier.qza"
